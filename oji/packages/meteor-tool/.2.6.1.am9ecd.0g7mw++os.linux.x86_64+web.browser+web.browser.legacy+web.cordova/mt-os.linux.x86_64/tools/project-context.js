!function (module1) {
  ...
  Object.assign(ProjectContext.prototype, {
    reset: function (moreOptions, resetOptions) {
      ...
      self.projectLocalDir = process.env.METEOR_LOCAL_DIR ? files.pathResolve(options.projectDir, files.convertToStandardPath(process.env.METEOR_LOCAL_DIR)) : options.projectLocalDir || files.pathJoin(self.projectDir, '.meteor', 'local');
      addWatchRoot(self.projectDir); // Used by 'meteor rebuild'; true to rebuild all packages, or a list of
