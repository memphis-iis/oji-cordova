...
var maybeShowBanners = function () {
  ...
  if (futureReleases.length) {
    ...
    if (shouldShow(futureReleaseKey)) {
      runLog.log("=> " + catalogUtils.displayRelease(track, futureReleases[0]) + " is available. Check the changelog https://docs.meteor.com/changelog.html and update this project with 'meteor update'.");
    }
